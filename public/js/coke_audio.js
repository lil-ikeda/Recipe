window.addEventListener('load', function() {
  ...
  speech.lang = 'ja-JP';
  const btn = document.getElementById('cokebtn');
  ...
  const audio_01 = `<div class="audiojs loading" classname="audiojs" id="audiojs_wrapper01">
                  <audio autoplay src="/audios/coke_audio_01.mp3">
                </audio>          
  ...
  const audio_02 = `<div class="audiojs loading" classname="audiojs" id="audiojs_wrapper01">
                      <audio autoplay src="/audios/coke_audio_02.mp3">
                      </audio>
                      <div class="play-pause">             
                        <p class="play"></p>             
                        <p class="pause"></p>             
  ...
  const audio_03 = `<div class="audiojs loading" classname="audiojs" id="audiojs_wrapper01">
                      <audio autoplay src="/audios/coke_audio_03.mp3">
                      </audio>
                      <div class="play-pause">             
                        <p class="play"></p>             
                        <p class="pause"></p>             
  ...
  const audio_04 = `<div class="audiojs loading" classname="audiojs" id="audiojs_wrapper01">
                      <audio autoplay src="/audios/coke_audio_04.mp3">
                      </audio>
                      <div class="play-pause">             
                        <p class="play"></p>             
                        <p class="pause"></p>             
